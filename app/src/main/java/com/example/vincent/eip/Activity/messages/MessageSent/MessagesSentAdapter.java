...
public class MessagesSentAdapter extends RecyclerView.Adapter<MessagesSentAdapter.MyViewHolder> {
    ...
    public MessagesSentAdapter(Messages infoEvents) {
